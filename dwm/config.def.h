...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_cyan,  "#F74215"},
};
...
static Key keys[] = {
	...
	{ MODKEY,                      -1,         XK_w,                spawn,          SHCMD("chromium") },
	{ MODKEY,                      -1,         XK_z,                spawn,          SHCMD("zathura") },
	{ MODKEY,                      -1,         XK_bracketleft,      spawn,          SHCMD("pamixer -d 5") },
	{ MODKEY,                      -1,         XK_bracketright,     spawn,          SHCMD("pamixer -i 5") },
	...
	{ MODKEY,                      XK_p,       XK_e,                spawn,          SHCMD("~/.config/dm/dmconf") },
	{ MODKEY,                      XK_p,       XK_k,                spawn,          SHCMD("~/.config/dm/dmkill") },
	{ MODKEY,                      XK_p,       XK_n,                spawn,          SHCMD("~/.config/dm/dmnews") },
	{ MODKEY,                      XK_p,       XK_c,                spawn,          SHCMD("~/.config/dm/dmcode") },
	{ MODKEY,                      XK_p,       XK_q,                spawn,          SHCMD("~/.config/dm/dmscrot") },
	{ MODKEY,                      XK_p,       XK_l,                spawn,          SHCMD("~/.config/dm/dmlogout") },
	TAGKEYS(                       -1,         XK_1,                                0)
	TAGKEYS(                       -1,         XK_2,                                1)
	TAGKEYS(                       -1,         XK_3,                                2)
	TAGKEYS(                       -1,         XK_4,                                3)
